    ...
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_hsl(var(--primary)/0.2),_transparent_30%),radial-gradient(circle_at_85%_12%,_hsl(var(--chart-2)/0.16),_transparent_28%),linear-gradient(180deg,_hsl(var(--background)),_hsl(var(--background)))] text-foreground">
      ...
      <div className="relative z-10 flex min-h-screen items-center px-4 py-8 sm:px-6 lg:px-10">
        <div className="mx-auto grid w-full max-w-7xl gap-6 xl:grid-cols-[minmax(0,1.1fr)_460px]">
          <section className="relative overflow-hidden rounded-[40px] border border-border/70 bg-[radial-gradient(circle_at_top_left,_hsl(var(--chart-2)/0.22),_transparent_34%),radial-gradient(circle_at_80%_18%,_hsl(var(--primary)/0.16),_transparent_30%),linear-gradient(145deg,_hsl(var(--card)),_hsl(var(--card)/0.8))] shadow-shell">
            ...
            <div className="pointer-events-none absolute right-8 top-8 flex rotate-6 flex-col gap-3 opacity-70">
              <div className="rounded-[22px] border border-white/10 bg-background/25 px-4 py-3 text-sm backdrop-blur">
              ...
              <div className="ml-10 flex items-center gap-3 rounded-[22px] border border-primary/20 bg-primary/10 px-4 py-3 text-sm text-primary backdrop-blur">
            ...
            <div className="relative flex h-full flex-col gap-8 p-6 sm:p-8 lg:p-10">
              ...
              <div className="flex items-center gap-4">
                <div className="flex h-16 w-16 items-center justify-center rounded-[22px] border border-border/70 bg-background/45 shadow-card">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {heroPanels.map((panel) => (
                  <div key={panel.label} className="rounded-[26px] border border-border/70 bg-background/30 p-5 backdrop-blur">
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                {trustNotes.map(({ title, body, icon: Icon }) => (
                  <div key={title} className="rounded-[28px] border border-border/70 bg-card/65 p-5">
